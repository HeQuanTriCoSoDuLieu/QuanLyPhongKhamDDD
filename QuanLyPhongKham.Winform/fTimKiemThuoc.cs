...
namespace QuanLyPhongKham.Winform
{
    public partial class fTimKiemThuoc : Form
    {
        ...
        private void btntimkiem_Click(object sender, EventArgs e)
        {
            ...
            //    listlskham = libraryService.TimKiemThuoc(txttimkiem.Text, timtheo, loaithuoc);
            //    dgvdsthuoc.DataSource = listlskham;
            //    dgvdsthuoc.Columns[0].HeaderText = "Mã thuốc"; dgvdsthuoc.Columns[0].Width = 100;
            ...
            {
                timtheo = 0;
                    if (libraryService.TimKiemThuoc(txttimkiem.Text, timtheo, loaithuoc).Count == 0)
                    {
                    ...
                    {
                        // dgvdsthuoc.DataSource = libraryService.TimKiemThuoc(txttimkiem.Text, timtheo, loaithuoc);
                        List<TimKiemThuoc> listlskham = new List<TimKiemThuoc>();
                        listlskham = libraryService.TimKiemThuoc(txttimkiem.Text, timtheo, loaithuoc);
                        dgvdsthuoc.DataSource = listlskham;
